...
#+END_NOTES
- Everything from the arrays slide, and...
...
| =begin=  | starts at the *first* item that moves *up* in indexes   |
| =end=    | starts at the *last* item that moves *up* in indexes    |
| =rbegin= | starts at the *first* item that moves *down* in indexes |
| =rend=   | starts at the *last* item that moves *down* in indexes  |
