...
- Do exercises with git
- Install necessary software for future training

* Meet the Instructors
- TODO: Add the 2018 instructors
...
#+BEGIN_NOTES
Now for the git part of the presentation
#+END_NOTES
